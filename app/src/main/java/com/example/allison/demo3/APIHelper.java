...
/**
 * Created by Allison on 2018-03-27.
 */

// An Application class runs at the start of your application booting up
// A global static class that you can access anywhere with 'getApplicationContext()'
public class APIHelper extends Application {
    private ArrayList<ListItem> item = null;
    private String currentUrl="http://acousti.co/feeds/venue/bell%20mts%20place";
